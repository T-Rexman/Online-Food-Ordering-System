...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:100,300,100,700,900|Display+Playfair:100,300,100,700"> 
  ...
  <!-- <div class="site-wrap"> -->
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="100">
            ...
            <p data-aos="fade-up" data-aos-delay="100"><a href="#section-login" class="btn btn-primary py-3 px-5 text-white">Order Now</a></p>
    ...
    <div class="site-section border-bottom" id="section-our-team">
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-primary">
            <h2 class="font-weight-light text-primary">My Team</h2>
          </div>
        </div>
        <div class="d-flex justify-content-center align-items-center" style="min-height: 15px;">
          <div class="d-flex align-items-center" style="padding-left: 50px;"> 
            <img src="images/tousif.jpg" alt="Image" class="img-fluid rounded mb-5 w-50 rounded-circle"   style="max-width: 200px;">
            <div class="person-details" style="margin-left: 50px;"> 
              <h3>Md Tousif Rehman</h3>
              <p><strong>USN No :<span style="color: #ff0000;"> 3VC20IS016</span></strong></p>
              <ul class="ul-social-circle list-inline">
                <li class="list-inline-item"><a href="#"><span class="icon-google"></span></a></li>
                <li class="list-inline-item"><a href="#"><span class="icon-linkedin"></span></a></li>
                <li class="list-inline-item"><a href="#"><span class="icon-github"></span></a></li>
          ...
          <div class="col-md-9">
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <a href="#" class="pl-0 pr-3"><span class="icon-google"></span></a>
